...
operand`,
            ...
            {
                opcode: 'CBW',
                name: 'Convert Byte to Word/Word to WordDouble',
                example: 'CBW',
        ...
        instructions: [{
                opcode: 'MOV',
                name: 'Move',
                example: 'Used to copy the byte or word from the provided source to the provided destination.',
                usage: ['TYPE : Reg , Reg :', 'MOV register , register', 'MOV word_reg , word_reg', 'TYPE : Reg , Mem :', 'MOV register , byte memory', 'MOV register , word memory', 'MOV register , byte label', 'MOV register , word label', 'TYPE : Mem , Reg :', 'MOV byte memory , byte-register', 'MOV word memory , word-register', 'MOV byte label , byte-register', 'MOV word label , word-register', 'TYPE : Reg , Immediate:', 'MOV byte-register , unsigned/signed byte number', 'MOV word-register , unsigned/signed word number', 'TYPE : Mem , Immediate :', 'MOV byte memory , unsigned/signed byte number', 'MOV word memory , unsigned/signed word number', 'MOV byte label , unsigned/signed byte number', 'MOV word label , unsigned/signed word number', 'TYPE : Seg-Reg,Reg:', 'MOV segment-register,word-register', 'TYPE : Reg,Seg-Reg,:', 'MOV word-register,segment-register', 'TYPE : Mem,Seg-Reg:', 'MOV memory,segment-register', 'MOV word label,segment-register', 'TYPE : Seg-Reg,Mem:', 'MOV segment-register,memory,', 'MOV segment-register,word label']
            },
            {
                opcode: 'XCHG',
                name: 'Exchange',
                ...
                description: 'This instruction performs the same operation as ADD instruction , but adds the carry flag bit to the result.',
                usage: [
                    'TYPE :  Reg , Reg :', , 'XCHG byte-register, byte-register ', 'XCHG word-register , word-register ', 'TYPE : Mem,Reg :', 'XCHG byte memory, byte-register ', 'XCHG word memory, word-register ', 'XCHG byte byte label, byte-register', 'XCHG word word label, word-register ', 'TYPE : Reg,Mem :', 'XCHG byte-register ,byte memory', 'XCHG word-register ,word memory', 'XCHG byte byte-register ,byte label', 'XCHG word word-register ,word_add'
                ]
            },
            {
                opcode: 'IN',
    ...
    },
    {
        ...
        instructions: [{
                ...
                usage: ['NOT register', 'NOT byte memory', 'NOT word memory', 'NOT word label', 'NOT byte label']
    ...
    },
    {
        ...
        instructions: [{
            ...
            },
            {
                ...
                name: "LODS",
                example: "LODS byte",
                description: "Used to store the string byte into AL or string word into AX.",
            ...
            },
            {
                ...
                description: "Used to repeat the given instruction until CX = 0 or zero flag ZF = 0.",
                usage: [
                    "REPE CMPS byte",
                    "REPE CMPS word",
                    "REPE SCAS byte",
            ...
            },
            {
                ...
                description: "Used to repeat the given instruction until CX = 0 or zero flag ZF = 1.",
                usage: [
                    "REPNE CMPS byte",
                    "REPNE CMPS word",
                    "REPNE SCAS byte",
