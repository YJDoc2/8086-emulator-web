...
function Compiler(props) {
	...
	const [flags, setFlags] = useState({ of: 0,
		df: 0,
		if: 0,
		tf: 0,
		sf: 0,
...
int 0x10                ; BIOS interrupt`
	...
	const addAnnotation = (errorText) => {
		...
		let rowNumber = re.exec(errorText.slice(errorText.indexOf('at line '), ))[1] - 1 //subtract 1 as index starts from 0
	...
	return (
      ...
      <Grid container spacing={2}>
        ...
        <Grid item lg={5} style={matches?{maxWidth: '100vw'}:null}>
          ...
          <TableContainer className={classes.flagTable} component={Paper} style={matches?null:{minWidth: 505}}>
            <Table size='small' aria-label='simple table'>
              <TableHead>
                <TableRow>
